...
import { RegisterMovementForm, RegisterMovementFormData } from '../RegisterMovementForm/RegisterMovementForm';
...
export function RegisterMovementModal({
  ...
  const handleSubmit = (data: RegisterMovementFormData) => {
    onSubmit(data);
    onClose();
  };
  ...
  return (
    ...
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Cadastrar nova movimentação"
    ...
    >
      ...
      <div className="relative z-10 mt-[122px] w-[500px] max-h-[calc(100vh-160px)] overflow-y-auto rounded-lg bg-white p-7 shadow-xl">
        ...
        <RegisterMovementForm onSubmit={handleSubmit} onCancel={onClose} />
      </div>
    </div>
  );
}
